...
export const LayoutBackground = ({ children, ...props }: LayoutBackgroundProps) => (
  <div
    className="relative before:absolute before:-z-10 before:-left-60 before:-top-60 before:bg-primary-3 before:blur-[100px] lg:before:blur-[280px] before:w-80 lg:before:w-180 before:h-80 lg:before:h-180 after:absolute after:-z-10 after:-left-30 after:bottom-0 after:bg-primary-3 after:blur-[150px] after:w-80 after:h-80"
    {...props}
  >
