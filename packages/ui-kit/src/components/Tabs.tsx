...
export const tabsListVariants = cva(
  'h-7.5 gap-4 group/tabs-list inline-flex w-full items-center justify-center',
  {
    variants: {
      variant: {
        default: 'mb-8 typo-heading-5 text-black-1 ',
        primary: 'mb-10 typo-heading-3 text-gray-1 tabs:h-8.5'
      }
    },
    defaultVariants: {
      variant: 'default'
...
export const TabsList = ({ className, variant = 'default', ...props }: TabListProps) => (
  <TabsPrimitive.List
    data-slot="tabs-list"
