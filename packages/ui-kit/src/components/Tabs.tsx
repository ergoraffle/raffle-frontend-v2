...
export const tabsListVariants = cva(
  'h-6.5 lg:h-7.5 gap-1 lg:gap-40 group/tabs-list inline-flex w-full items-center justify-around lg:justify-center',
  {
    variants: {
      variant: {
        default: 'mb-8 typo-heading-5 text-black-1',
        primary: 'mb-6.5 lg:mb-10 typo-heading-3 text-gray-1 tabs:h-8.5 h-9'
      }
    },
    defaultVariants: {
      variant: 'default'
